        ...
        doPost: function (settings) {
            ...
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    if(obj.error == 1){
                        $('#failmessage').html('<div class="alert alert-callout alert-danger">'+obj.data.User.email+'<button aria-hidden="true" data-dismiss="alert" class="close" type="button"><span class="fa fa-times-circle" ></span></button></div>');
                    }
                    return false;
